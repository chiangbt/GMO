...
export default {
  ...
  methods: {
    _createMapView () {
      ...
      loadModules(['esri/Map', 'esri/views/MapView', 'esri/layers/TileLayer', 'esri/widgets/CoordinateConversion'], option)
        .then(([Map, MapView, TileLayer, CoordinateConversion]) => {
            var map = new Map({
                basemap: 'hybrid',
